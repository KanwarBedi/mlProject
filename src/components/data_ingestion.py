...
@dataclass
class DataIngestionConfig:                                 #after this data ingestion knows where to save train, test and raw data
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            return(
                ...
                self.ingestion_config.test_data_path        #returning the training data and test data part to next step
